...
INSERT INTO product(id,name,price,instock,inorder,reorder,description)VALUES(1,'Gloves',50,12,0,10,'Quantity in 1 Box - 100 Gloves = 50 pairs in 1 box.');
...
INSERT INTO productmongo(id,detail)VALUES(1,'{"id":1,"name":"Gloves","description":"Quantity in 1 Box - 100 Gloves = 50 pairs in 1 box","price":50,"instock":12}');
